public class WTF_Benevole_v1 {
    ...
    //                 // System.out.println("\nList Benevoles");
    //                 // for (Benevole b : arrCheckIfBenevolesPresentInFile)
    ...
    //                 // System.out.println("Array is not Null: " + Boolean.toString(arrCheckIfBenevolesPresentInFile != null));
    //                 // System.out.println("Array is not Empty: " + Boolean.toString(arrCheckIfBenevolesPresentInFile.size()>0));
    //                 // System.out.println("\n");
    ...
    //                     // blnAlertErrorDataFileBenevole = true;
    ...
    //                             //! System.out.println(Arrays.toString(strArrLogin));
    ...
    //                                 // try {
    //                                 //     strDateNaissance = strArrLogin[2]; //arrCurrentLigne[2];
    //                                 // } 
    //                                 // catch (IndexOutOfBoundsException ioobe) {
    //                                 //     if (blnShowVerbose) {
    //                                 //         // System.err.println("Error: 'strDateNaissance' Index Out Of Bound at line " + intCurrentLineNumber + ":\t" + ioobe.toString());
    //                                 //         logger.log(Level.WARNING, "Error 'strDateNaissance' Index Out Of Bound at line " + intCurrentLineNumber); //
    //                                 //     }
    //                                 //     strDateNaissance = "";
    //                                 // }
